...
def test_one():
    ...
    print(result)
    chinese_text = get_chinese_text(result)
    if chinese_text:
        print(f"Chinese text: {chinese_text}")
    else:
        print("No Chinese text found.")
    # print(result['result']['payload_msg']['result']['text'])
    # print(result.get('result', {}).get('payload_msg', {}).get('result', {}).get('text', ''))
...
if __name__ == '__main__':
    test_one()
    print(convert_to_text(audio_path))
